...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="margin-top:100px">
        <center><h1>添加用户信息</h1></center>
        <!-- 内容主体区域 -->
        <form class="layui-form" action="/useradd.do" style="margin-top:20px;margin-left:150px;margin-right: 400px;">
            <div class="layui-form-item" width="100px">
                <label class="layui-form-label">用户名</label>
                <div class="layui-input-block" >
                    <input type="text" name="username"  placeholder="请输入用户名"  class="layui-input" value=${user.username}>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">用户密码</label>
                <div class="layui-input-block">
                    <input type="text" name="password"  placeholder="请输入密码"  class="layui-input" value=${user.password}>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">电话号码</label>
                <div class="layui-input-block">
                    <input type="text" name="phone" required  lay-verify="required" placeholder="请输入电话号码" autocomplete="off" class="layui-input" value=${user.phone}>
                </div>
            </div>
            <div class="layui-form-item">
