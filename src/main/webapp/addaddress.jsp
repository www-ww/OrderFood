...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <form action="/addaddress.do" method="get" style="margin-top: 200px">
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label" style="width: 100px;margin-left: 200px" >
                    ${msg}
                </label>
                <div class="layui-input-block">
                    <input type="text" name="textadd" placeholder="请输入内容" class="layui-textarea" style="margin-left: 200px;width: 400px;">
