    ...
    <div class="layui-body">
        ...
        <div style="padding: 30px;">
            ...
            <div style="float: right;padding-right: 80px;">
                ...
                <a  class="btn btn-primary" href="echarts.jsp">查看总榜</a>
            </div>
            <form action="" name="myForm" style="margin-top:50px">
                <table class="layui-table" lay-data="{width: 1200, height:500, page:true, id:'idTest'}" name="idTest">
                    ...
                    <tr>
                        ...
                        <th lay-data="{field:'src', width:250}">图片地址</th>
                        <th lay-data="{field:'sale', width:130}">商户</th>
                        <%--                    <th lay-data="{field:'wealth', width:135, sort: true}">财富</th>--%>
                        <%--                    <th lay-data="{field:'score', width:80, sort: true, fixed: 'right'}">评分</th>--%>
                        <th lay-data="{field:'do', width:200}">操作</th>
                    </tr>
                    </thead>
                    <!--循环读取值-->
                    <c:forEach items="${list}" var="food">
                        <tr>
                            ...
                            <td>${food.img}</td>
                            <td>${food.storeid}</td>
                            <td><a href="/foodup.do?foodid=${food.foodid}" class="layui-btn">修改</a>
                                <a href="/fooddel.do?foodid=${food.foodid}" class="layui-btn layui-btn-normal">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
